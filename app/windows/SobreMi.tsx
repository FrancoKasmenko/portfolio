...
const skills = [
  { nombre: "JS", label: "JS (ES6+)", color: "#f7df1e", text: "#222" },
  { nombre: "HTML5", label: "HTML5", color: "#e44d26" },
  { nombre: "CSS3", label: "CSS3", color: "#1572b6" },
  { nombre: "Bootstrap", label: "Bootstrap", color: "#7e13f8" },
  ...
  { nombre: "Nextjs", label: "Next.js", color: "#111", text: "#fff" }
];
    ...
    <div className="w-full min-h-[95vh] px-8 py-10 flex flex-col items-center bg-[#d6d7d8] font-mono select-none overflow-auto">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start w-full max-w-4xl gap-8 mb-5">
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-[#232323] mt-1">{t("tituloProfesional")}</h2>
          <p className="text-base md:text-lg text-[#444]">{t("subtituloProfesional")}</p>
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            <a href="https://linkedin.com/in/franco-kasmenko" target="_blank" className="underline hover:text-blue-700">LinkedIn</a>
            <a href="https://github.com/FrancoKasmenko" target="_blank" className="underline hover:text-blue-700">GitHub</a>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 w-full max-w-4xl">
        ...
        <ul className="space-y-6">
          ...
          <li className="rounded-lg bg-[#ededed] border-l-4 border-[#1c4bdd] p-4 shadow-inner">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 gap-1">
              <span className="font-bold text-[#191b24]">{t("expAstroTitulo")}</span>
              <span className="text-xs text-[#1c4bdd]">{t("expAstroLugar")}</span>
            </div>
            <span className="text-xs text-[#3c3c3c]">{t("expAstroPuesto")}</span>
          ...
          <li className="rounded-lg bg-[#ededed] border-l-4 border-[#1c4bdd] p-4 shadow-inner">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 gap-1">
              <span className="font-bold text-[#191b24]">{t("expNetpcTitulo")}</span>
              <span className="text-xs text-[#1c4bdd]">{t("expNetpcLugar")}</span>
            </div>
            <span className="text-xs text-[#3c3c3c]">{t("expNetpcPuesto")}</span>
      ...
      {/* EDUCACIÓN */}
      <div className="mt-10 w-full max-w-4xl">
        <h2 className="text-lg font-bold mb-2 text-[#181b22]">{t("educacionTitulo")}</h2>
        <ul className="space-y-3">
          <li>
            <span className="font-bold">{t("eduOrt")}</span> - {t("eduOrtTitulo")}
            <br />
            <span className="text-xs text-[#1c4bdd]">{t("eduOrtLugar")}</span> · <span className="text-xs">{t("eduOrtTiempo")}</span>
          </li>
          <li>
            <span className="font-bold">{t("eduEsi")}</span> - {t("eduEsiTitulo")}
            <br />
            <span className="text-xs text-[#1c4bdd]">{t("eduEsiLugar")}</span> · <span className="text-xs">{t("eduEsiTiempo")}</span>
          </li>
        </ul>
      </div>
      ...
      {/* SKILLS ADICIONALES */}
      <div className="mt-10 w-full max-w-4xl">
        <h2 className="text-lg font-bold mb-2 text-[#181b22]">{t("skillsTitulo")}</h2>
